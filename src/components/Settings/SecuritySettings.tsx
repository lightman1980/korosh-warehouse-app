          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="mr-auto px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
              >
                {isLoading ? 'در حال ذخیره...' : 'ذخیره فوری'}
              </button>
            </div>
          </div>
        )}
